<?php
function schoolwebsite_register_custom_post_types() {
    ...
    register_post_type( 'schoolwebsite-staff', $args );
...
add_action( 'init', 'schoolwebsite_register_custom_post_types' );

// Staff and Student taxonomies
function schoolwebsite_register_taxonomies() {
    ...
    register_taxonomy( 'schoolwebsite-staff-category', array( 'schoolwebsite-staff' ), $args );

    // Adding a Student Category Taxonomy
    $labels = array(
    ...
    register_taxonomy( 'studentt-category', array( 'school-students' ), $args );
    
}
add_action( 'init', 'schoolwebsite_register_taxonomies');
